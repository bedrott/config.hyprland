...
hl.monitor({
    output   = "HDMI-A-1", --nome do seu monitor
    mode     = "1920x1080@180", --resolucao e hz do seu monitor
    position = "0x0", 
    scale    = "1",
})
...
hl.animation({ leaf = "windowsOut",    enabled = true,  speed = 1.49, bezier = "linear",       style = "slide top" })
